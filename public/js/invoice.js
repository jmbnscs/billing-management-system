...
async function setInvoicePage () {
    ...
    const [content, invoice_status, customers] = await Promise.all ([fetchData('views/invoice_unpaid_per_account.php'), fetchData('statuses/read.php?status_table=invoice_status'), fetchData('views/customer.php')]);
