// Directories
const DIR_API = location.protocol + '//' + location.host + '/api/api/';
const DIR_MAIN = '/finalsbms/public/';
const DIR_APP = location.protocol + '//' + location.host + '/finalsbms/app/includes/';
